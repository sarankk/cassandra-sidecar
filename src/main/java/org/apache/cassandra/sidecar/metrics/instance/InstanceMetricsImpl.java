...
public class InstanceMetricsImpl implements InstanceMetrics
{
    ...
    protected final InstanceRestoreMetrics instanceRestoreMetrics;
    ...
    public InstanceMetricsImpl(InstanceMetricRegistry instanceMetricRegistry)
    {
        ...
        this.instanceRestoreMetrics = new InstanceRestoreMetrics(instanceMetricRegistry);
    }
