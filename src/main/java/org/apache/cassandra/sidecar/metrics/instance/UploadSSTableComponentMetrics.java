...
public class UploadSSTableComponentMetrics
{
    ...
    protected final DefaultSettableGauge<Long> bytesUploaded;
    protected final Meter rateLimitedCalls;
    protected final Meter diskUsageHighErrors;
    protected final DefaultSettableGauge<Long> totalBytesUploaded;
                                         ...
                                         String sstableComponent)
    {
        ...
        bytesUploaded = instanceMetricRegistry.gauge(new MetricName(FEATURE,
                                                                    "bytes_uploaded",
                                                                    "component=" + sstableComponent).toString(),
        ...
        diskUsageHighErrors = instanceMetricRegistry.meter(new MetricName(FEATURE,
                                                                          ...
                                                                          "component=" + sstableComponent).toString());
        totalBytesUploaded = instanceMetricRegistry.gauge(new MetricName(FEATURE,
                                                                         "total_bytes_uploaded").toString(),
                                                          () -> new DefaultSettableGauge<>(0L));;
    }
    ...
    {
        bytesUploaded.setValue(bytes);
        totalBytesUploaded.setValue(bytes);
    }
