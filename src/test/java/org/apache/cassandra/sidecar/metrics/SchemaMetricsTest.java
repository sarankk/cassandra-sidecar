...
public class SchemaMetricsTest
{
    ...
    public void testSchemaModificationFailure()
    {
        ...
        while (getMetric("sidecar.schema.failed_initializations", Meter.class).getCount() <= 0)
        {
            // no op, wait until initialization emits metrics
        }
        assertThat(getMetric("sidecar.schema.failed_modifications", Meter.class).getCount())
    ...
    public static class SchemaFailureSimulateModule extends AbstractModule
    {
                                           ...
                                           CQLSessionProvider cqlSessionProvider)
        {
            ...
            return new SidecarSchema(vertx, executorPools, configuration,
                                     metrics, sidecarInternalKeyspace, cqlSessionProvider);
        }
    }
}
