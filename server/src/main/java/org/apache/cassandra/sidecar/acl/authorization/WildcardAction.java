...
public class WildcardAction extends StandardAction
{
    ...
    public WildcardAction(String name)
    {
        ...
        {
            throw new ConfigurationException("Wildcard actions must either have wildcard token " + WILDCARD_TOKEN
    ...
    private void validate(String name)
    {
        ...
        {
            throw new ConfigurationException("Wildcard action parts can not be empty");
        }
    }
