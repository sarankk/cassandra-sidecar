 ...
 */
public class OperationalJobHandler extends AbstractHandler<Void> implements AccessProtected
{
    ...
    {
        return ImmutableSet.of(SidecarActions.VIEW_TASKS.toAuthorization());
    }
