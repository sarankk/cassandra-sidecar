...
public class AccessControlConfigurationImpl implements AccessControlConfiguration
{
    ...
    private static final List<RolePermissionsConfiguration> DEFAULT_ROLE_PERMISSIONS_CONFIGURATIONS = Collections.emptyList();
    ...
    protected final List<RolePermissionsConfiguration> rolePermissionsConfigurations;
    ...
    public AccessControlConfigurationImpl()
    {
        this(DEFAULT_ENABLED, DEFAULT_AUTHENTICATORS_CONFIGURATION, DEFAULT_AUTHORIZER_CONFIGURATION,
             DEFAULT_ADMIN_IDENTITIES, DEFAULT_ROLE_PERMISSIONS_CONFIGURATIONS, DEFAULT_PERMISSION_CACHE_CONFIGURATION);
    }
                                          ...
                                          CacheConfiguration permissionCacheConfiguration)
    {
        ...
        this.rolePermissionsConfigurations = rolePermissionsConfigurations;
    ...
    public List<RolePermissionsConfiguration> rolePermissionsConfigurations()
    {
        return rolePermissionsConfigurations;
    }
