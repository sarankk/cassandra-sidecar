 ...
 * - *:* allows all possible permissions for specified resource or across resources
 */
public class SidecarActions
{
    ...
    public static final Action CREATE_RESTORE = new WildcardAction("CREATE:RESTORE");
    public static final Action VIEW_RESTORE = new WildcardAction("VIEW:RESTORE");
    public static final Action UPDATE_RESTORE = new WildcardAction("UPDATE:RESTORE");
    public static final Action ABORT_RESTORE = new WildcardAction("ABORT:RESTORE");
